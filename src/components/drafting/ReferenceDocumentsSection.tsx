...
interface ReferenceDocumentsSectionProps {
  ...
  setSampleDocuments: React.Dispatch<React.SetStateAction<EnhancedSampleDocument[]>>;
  selectedReferenceDocuments: string[];
  setSelectedReferenceDocuments: React.Dispatch<React.SetStateAction<string[]>>;
  isUploadDialogOpen: boolean;
  setIsUploadDialogOpen: (open: boolean) => void;
  previewDocument: EnhancedSampleDocument | null;
  setPreviewDocument: (doc: EnhancedSampleDocument | null) => void;
}

const ReferenceDocumentsSection: React.FC<ReferenceDocumentsSectionProps> = ({
  documentType,
  sampleDocuments,
  setSampleDocuments,
  selectedReferenceDocuments,
  setSelectedReferenceDocuments,
  isUploadDialogOpen,
